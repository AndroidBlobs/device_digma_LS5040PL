PRODUCT_PROPERTY_OVERRIDES +=  \
    ...
    persist.cs.fp.chips=358 \
    persist.cs.fp.doubleclick.time=300 \
    persist.cs.fp.doubleclick=true \
    persist.cs.fp.down_up_click=false \
    persist.cs.fp.enroll_count=12 \
    persist.cs.fp.key.doubleclick=64 \
    persist.cs.fp.key.down=66 \
    persist.cs.fp.key.down_and_up=189 \
    persist.cs.fp.key.left=67 \
    persist.cs.fp.key.longtouch=63 \
    persist.cs.fp.key.right=68 \
    persist.cs.fp.key.singleclick=87 \
    persist.cs.fp.key.up=65 \
    persist.cs.fp.key_support=true \
    persist.cs.fp.longtouch.time=500 \
    persist.cs.fp.longtouch=true \
    persist.cs.fp.navigation=true \
    persist.cs.fp.repeat_enroll=false \
    persist.cs.fp.samespace_enroll=false \
    persist.cs.fp.singleclick=true \
